  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-neutral-200 overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-600 mt-1">Select the dimensions that best fit your platform</p>
            </div>
          </div>
          <div className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold shadow-sm">4</div>
        </div>
      </div>
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-neutral-900 mb-4">Quick Select by Platform</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Square Format Group */}
            <div className="flex flex-col gap-2">
              <div className="text-sm font-medium text-neutral-600 mb-1">Square Format (1:1)</div>
              <button
                type="button"
            ...
            {/* Story Format Group */}
            <div className="flex flex-col gap-2">
              <div className="text-sm font-medium text-neutral-600 mb-1">Story Format (9:16)</div>
              <button
                type="button"
            ...
            <div className="flex flex-col gap-2">
              <div className="text-sm font-medium text-neutral-600 mb-1">Landscape Format (16:9)</div>
              <button
                type="button"
            ...
            <div className="border-t border-neutral-200 pt-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  />
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-neutral-900">Square</h3>
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">1:1</span>
                    </div>
                    <div className="space-y-1.5">
                      <p className="text-sm text-neutral-700">Perfect for:</p>
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">4:5</span>
                    </div>
                    <div className="space-y-1.5">
                      <p className="text-sm text-neutral-700">Perfect for:</p>
                      <ul className="text-sm text-neutral-600 list-disc list-inside space-y-0.5">
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-neutral-900">Story</h3>
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">9:16</span>
                    </div>
                    <div className="space-y-1.5">
                      <p className="text-sm text-neutral-700">Perfect for:</p>
                      <ul className="text-sm text-neutral-600 list-disc list-inside space-y-0.5">
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-neutral-900">Landscape</h3>
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">16:9</span>
                    </div>
                    <div className="space-y-1.5">
                      <p className="text-sm text-neutral-700">Perfect for:</p>
                      <ul className="text-sm text-neutral-600 list-disc list-inside space-y-0.5">
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-neutral-900">Wide</h3>
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">1.91:1</span>
                    </div>
                    <div className="space-y-1.5">
                      <p className="text-sm text-neutral-700">Perfect for:</p>
                      <ul className="text-sm text-neutral-600 list-disc list-inside space-y-0.5">
                ...
                <label className="relative cursor-pointer h-full">
                  ...
                  <div className="p-4 rounded-xl border-2 border-neutral-200 bg-neutral-50 peer-checked:border-primary peer-checked:bg-primary/5 transition-all duration-200 h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-neutral-900">Custom</h3>
                      <span className="px-2 py-0.5 rounded bg-neutral-200 text-neutral-700 text-xs font-medium">Other</span>
                    </div>
                    <div className="space-y-3">
                      <p className="text-sm text-neutral-700">Enter custom dimensions:</p>
