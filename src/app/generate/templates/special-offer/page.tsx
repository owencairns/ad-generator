  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        price: includePrice ? price.trim() : null,
        discount: includeDiscount ? discount.trim() : null,
      };
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg text-base-content/70">Create an eye-catching promotional ad for your special offer</p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-end gap-4 pt-6">
                <button
                  ...
                  className={`btn rounded-full px-8 normal-case text-base font-medium hover:scale-105 transition-transform gap-2 min-w-[200px] ${
                    productImages.length === 0 || !offerDescription.trim() || isGenerating ||
                    (includePrice && !price.trim()) || (includeDiscount && !discount.trim())
                      ? 'btn-disabled bg-base-300'
                      : 'btn-primary'
                  }`}
                  disabled={productImages.length === 0 || !offerDescription.trim() || isGenerating ||
                    (includePrice && !price.trim()) || (includeDiscount && !discount.trim())}
                >
                  {isGenerating ? (
                    'Generating...'
